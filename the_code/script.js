...
/*
var titre = document.getElementById("titre"); // Chercher la valeur avec le titre
var newTitre = titre;
...
function the_refresh() {
    ...
    location.reload();
    /*
    if (confirm('Are you sure you want to refresh the page ? Your choices will be LOST !')) {
    } else {
    }
    */
}
